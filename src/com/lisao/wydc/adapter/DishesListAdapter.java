...
import com.lisao.wydc.ui.ShowActivity;
import com.lisao.wydc.utils.ImageLoader;
...
public class DishesListAdapter extends BaseListAdapter<Dishes> {
	...
	public View bindView(final int position, View convertView, ViewGroup parent) {
		...
		html += "<font color='#a29686'>元</font>";
		dishes_price.setText(Html.fromHtml(html));// Html.fromHtml()将普通文字值转换为带HTML标记语言的值
		dishes_sum.setText(Html.fromHtml("<font color='#a29686'>总销量</font>"
