package com.lisao.wydc.fragment;

import com.lisao.wydc.R;
import com.lisao.wydc.bean.User;
import com.lisao.wydc.config.Config;
import com.lisao.wydc.ui.CartActivity;
import com.lisao.wydc.ui.HistoryCartActivity;
import com.lisao.wydc.ui.UserInfoActivity;
import com.lisao.wydc.utils.CurrentUserUitl;
import com.lisao.wydc.view.RoundImageView;
...
public class MyFragment extends FragmentBase implements OnClickListener {
	...
	private void init() {
		...
		/*
		 * 对各控件设计 点击（click）监听  （onclickListener）
		 * Listener（）里边的代码  为点击是执行的操作
		 * 因为  MyFragment 继承OnClickListener 接口  所以 他本身也是一个OnClickListener
		 * 所以这里 直接写 this
		 * */
		...
		/*headPicture本身继承 SmartImageView 是一个第三方的开源控件
		 * 可以通过url直接从网上下载图片显示在本地
		 * */
