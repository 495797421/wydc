...
import com.lisao.wydc.ui.DescripeActivity;
import com.lisao.wydc.ui.LoginActivity;
import com.lisao.wydc.ui.FeedBackActivity;
	...
	private void init() {
		...
		expandableListView.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				/*通过获得的 groupPosition 与childPosition判断点击的位置
				 * 传递不同的参数
				 * */
