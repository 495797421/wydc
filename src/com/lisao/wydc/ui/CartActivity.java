...
import com.lisao.wydc.adapter.CartListAdapter;
import com.lisao.wydc.bean.Cart;
...
public class CartActivity extends ActivityBase implements OnClickListener,
		...
		public void handleMessage(Message msg) {
			...
			case PAY:
				...
				if (result.equals("y")) {
					...
					ShowToast("支付完成，本次共消费  ¥：" + sum + "元");
					data.clear();
					cart_list_adapter.setList(data);
				}
				cart_sum_price.setText("¥" + 0 + "元");
				break;
			case NO:
				// 删除购物车中的所有物品
	...
	public boolean onItemLongClick(AdapterView<?> parent, View view,
		...
		builder.setTitle("提示");
		builder.setMessage("是否要删除所选择的商品?");
